package com.dat.state;

import com.dat.effect.CacheDataLoader;
import com.dat.effect.FrameImage;
import com.dat.gameobjects.BackgroundMap;
import com.dat.gameobjects.BulletManager;
import com.dat.gameobjects.Camera;
import com.dat.gameobjects.DarkRaise;
import com.dat.gameobjects.FinalBoss;
import com.dat.gameobjects.MegaMan;
import com.dat.gameobjects.ParticularObject;
import com.dat.gameobjects.ParticularObjectManager;
import com.dat.gameobjects.PhysicalMap;
import com.dat.gameobjects.RedEyeDevil;
import com.dat.gameobjects.RobotR;
import com.dat.gameobjects.SmallRedGun;
import com.dat.userinterface.GameFrame;
import com.dat.userinterface.GamePanel;
...
public class GameWorldState extends State {
    ...
    public GameWorldState(GamePanel gamePanel){
        ...
        texts1[0] = "Ta là Trần Công Đạt đây, ta đến đây để bảo vệ Trái Đất này....";
        texts1[1] = "Có một con quái vật đã xâm chiếm Trái Đất 10 năm qua\n"
                + "và con người đang phải sống trong nỗi sợ hãi....";
        texts1[2] = "Đến lúc rồi các đồng chí, hãy tiến lên để bảo về Trái Đất nào!....";
        texts1[3] = "      LET'S GO!.....";
        ...
        if(g2!=null){
            ...
            switch(state){
                case INIT_GAME:
                    ...
                    g2.fillRect(0, 0, GameFrame.SCREEN_WIDTH, GameFrame.SCREEN_HEIGHT);
                    g2.setColor(Color.WHITE);
                    g2.drawString("Nhan ENTER de tiep tuc", 400, 300);
                    break;
                case PAUSEGAME:
                    g2.setColor(Color.BLACK);
